...
import com.komnacki.sportresultstracker.funtional.Utils.ChartContainerCountAssertion
...
class AddNewRecordFromChartTest {
    ...
    fun testIfAddNewUserDialogAppear() {
        ...
        onView(withId(R.id.charts_container))
                .check(ChartContainerCountAssertion(TestUtils.NUMBER_OF_CHARTS))
        ...
        onView(withId(R.id.charts_container))
                .check(ChartContainerCountAssertion(2))
